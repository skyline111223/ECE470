...
def main():
	...
	high_dest_position = [-117.7e-3,-256e-3, 100e-3]
	rect_dest_position = [295e-3,-135e-3,100e-3]
	oval_dest_position = [295e-3, -230e-3, 100e-3]
